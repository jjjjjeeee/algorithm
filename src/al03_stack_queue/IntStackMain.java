...
public class IntStackMain {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			// 메뉴표시: push, pop, peek, print, search, empty, stact정보표시, 종료
			...
			case 7: 
				...
				System.out.println("데이터 개수: "+stack.getSize());// 데이터 개수
				System.out.println("데이터 존재여부: "+((stack.isEmpty())?"비어있음":"데이터있음"));// 비어있는지 확인
				System.out.println("데이터 Full여부: "+((stack.isFull())?"가득참":"여유있음"));// 가득찼는지 확인
