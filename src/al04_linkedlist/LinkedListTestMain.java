...
public class LinkedListTestMain {
	...
	static class Data{
		...
		public void scanData(String msg, int s) {
			...
			if((s & NAME) == NAME) {
				// 이름입력
				System.out.print("이릅->");
				name = scan.next(); // 공백을 기준으로 한 단어를 입력, nextLine()은 엔터까지 
			}
		}	
	}
	...
	public static void main(String[] args) {
		Menu menu; // 선택한 메뉴
		// linkedlist에 data만 들어갈 수 있도록 함(제네릭스)
		...
		do {
			...
			case ADD_FIRST: // 머리에 노드 삽입
				data = new Data();
				data.scanData("머리 노드 삽입",Data.NO | Data.NAME); // |: bit or연산
